 ...
 * @since 0.0.1
 */
public class TDengineJDSLExtension implements ExtensionMain {
    private com.huskar_t.TDengineJDSL tdengine;
    private static final @NotNull Logger log = LoggerFactory.getLogger(com.huskar_t.TDengineJDSLExtension.class);
    ...
    public void extensionStart(final @NotNull ExtensionStartInput extensionStartInput, final @NotNull ExtensionStartOutput extensionStartOutput) {
        try {
            ...
            tdengine = new com.huskar_t.TDengineJDSL(path.getAbsolutePath());
            boolean success = tdengine.connect();
            if (!success) {
                throw new Exception("connect to tdengine error");
            }
            addPublishModifier();
    ...
    private void addPublishModifier() {
        ...
        final TDengineJDSLInterceptor TDengineInterceptor = new TDengineJDSLInterceptor(this.tdengine);
